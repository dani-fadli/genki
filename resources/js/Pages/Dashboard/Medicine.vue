                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tr>
                                ...
                                <th class="px-4 py-3" scope="col">Stock</th>
                                <th class="px-4 py-3" scope="col">Sales/Day</th>
                                <th class="px-4 py-3" scope="col">Sales/Month</th>
                                <th class="px-4 py-3" scope="col">Rating</th>
                                <th class="px-4 py-3" scope="col">Sales</th>
                                <th class="px-4 py-3" scope="col">Revenue</th>
                                <th class="px-4 py-3" scope="col">Last Update</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center">
                                        <svg aria-hidden="true" class="w-5 h-5 mr-2 text-gray-400" fill="currentColor"
