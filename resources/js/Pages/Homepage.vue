        ...
        <div
            ...
            <div class="me-auto place-self-center lg:col-span-7">
                <h1 class="mb-3 text-2xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white md:text-4xl">
                    Layanan Apotek Online Terpercaya
                </h1>
                <p class="mb-6 text-gray-500 dark:text-gray-400"> Temukan berbagai macam obat, vitamin, dan suplemen
                    dengan deskripsi lengkap dan harga terjangkau.
                ...
                <p class="my-2 text-gray-500 dark:text-gray-400">atau</p>

                <button
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    type="button"
                >
                    <a href="#medicines-by-categories">
                        Telusuri Katalog
                    </a>
                    <svg aria-hidden="true" class="rtl:rotate-180 w-3.5 h-3.5 ms-2" fill="none"
    ...
    <section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="mb-4 flex items-center justify-between gap-4 md:mb-8">
                <h2 id="medicines-by-categories"
                    class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">
                    Obat Berdasarkan Kategori
                </h2>

                <a class="flex items-center text-base font-medium text-primary-700 hover:underline dark:text-primary-500"
                   href="#"
                   title="">
                    Lihat semua
                    <svg aria-hidden="true" class="ms-1 h-5 w-5" fill="none" height="24"
                         viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19 12H5m14 0-4 4m4-4-4-4" stroke="currentColor" stroke-linecap="round"
                              stroke-linejoin="round"
                              stroke-width="2"/>
                    </svg>
                </a>
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <a class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
                   href="#">
                    <svg aria-hidden="true" class="me-2 h-4 w-4 shrink-0 text-gray-900 dark:text-white"
                ...
                <a class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
                   href="#">
                    <svg aria-hidden="true" class="me-2 h-4 w-4 shrink-0 text-gray-900 dark:text-white"
                         fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 9a3 3 0 0 1 3-3m-2 15h4m0-3c0-4.1 4-4.9 4-9A6 6 0 1 0 6 9c0 4 4 5 4 9h4Z"
                              stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                              stroke-width="2"></path>
                    </svg>
                   ...
                   href="#">
                    <svg aria-hidden="true" class="me-2 h-4 w-4 shrink-0 text-gray-900 dark:text-white"
                        ...
                        <path
                            ...
                            stroke="currentColor" stroke-linejoin="round"
                            stroke-width="2"></path>
                        <path d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" stroke="currentColor" stroke-linejoin="round"
                              stroke-width="2"></path>
                    </svg>
                ...
                <a class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
                   href="#">
                    <svg aria-hidden="true" class="me-2 h-4 w-4 shrink-0 text-gray-900 dark:text-white"
                         fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 15h7.01v.01H15L8 15Z" stroke="currentColor" stroke-linecap="square"
                              stroke-width="2"/>
